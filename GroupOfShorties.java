...
public class GroupOfShorties implements Locatable{
    ...
    public void disband() {
        ...
        System.out.println("Группа ( " + this + " ) расформирована" + "\n");
        for (Shorty shorty : group) {
            delShorty(shorty);
        }
        group = null;
    ...
    public void haveDinner() {
        ...
        if (cook != null) {
            ...
            System.out.println("В группе нет повара, чтобы устроить прием пищи" + "\n");
        }
    }
